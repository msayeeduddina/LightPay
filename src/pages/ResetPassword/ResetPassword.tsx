...
import { RESET_INFO } from '../../models/user.models';
import './ResetPassword.css';
const eye = <FontAwesomeIcon icon={faEye} />;

const ResetPassword = () => {
  const [formData, setFormData] = useState(RESET_INFO);
        ...
        <div className="heading">
          ...
          >
            ...
            >
              ...
              />
              <i className="eye" onClick={togglePasswordVisibilities}>
                {eye}
              </i>
            </div>
